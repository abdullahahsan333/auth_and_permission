...
class RdataTB {
    constructor(IdTable, Options = { RenderJSON: null,
        ...
        this.searchValue = '';
        this.ListHiding = [];
        this.SelectionNumber = [5, 10, 15, 50];
    ...
    paginateRender() {
        const k = ` <div class="pagination justify-content-end overflow-hidden" id="pgN"><a id="x__PREV__X" style="cursor:pointer;user-select: none;">&laquo;</a><div id="PF"></div><a id="x__NEXT__X" style="cursor:pointer;user-select: none;">&raquo;</a></div>`;
